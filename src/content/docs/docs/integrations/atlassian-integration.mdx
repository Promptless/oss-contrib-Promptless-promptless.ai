...
| `write:jira-work` | Create Jira issues and link them to existing tickets |
...
<Info>
Confluence scopes include both classic and granular variants for compatibility with Atlassian's API v2. Promptless reads Jira issues and Confluence pages for documentation context, and can create new Jira issues to track documentation work.
</Info>
...
Once connected, you can use Jira and Confluence to enhance documentation workflows:

- **Jira**: Automatically retrieve ticket information, search for related issues using JQL queries, and create new issues to track documentation work. See the [Jira Context Source](/docs/configuring-promptless/context-sources/jira) page for details.

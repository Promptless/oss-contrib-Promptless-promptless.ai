...
Jira issues created by Promptless are automatically linked to the documentation suggestions that triggered them. These links appear as compact pills in the suggestion detail header on the Promptless dashboard. Click a Jira pill to open the issue directly in Jira.
